"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_pages_Analytics_Analytics_js"],{

/***/ "./resources/js/pages/Analytics/Analytics.js":
/*!***************************************************!*\
  !*** ./resources/js/pages/Analytics/Analytics.js ***!
  \***************************************************/
...
var AnalyticsComponent = /*#__PURE__*/function (_React$Component) {
  _inherits(AnalyticsComponent, _React$Component);

  var _super = _createSuper(AnalyticsComponent);
  ...
  function AnalyticsComponent(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "byCountry", function () {
      document.getElementById('city').classList.remove('text-primary');
      document.getElementById('country').classList.add('text-primary');

      _this.setState({
        current: _toConsumableArray(_this.state.country)
      });
    });

    _defineProperty(_assertThisInitialized(_this), "byCity", function () {
      document.getElementById('city').classList.add('text-primary');
      document.getElementById('country').classList.remove('text-primary');

      _this.setState({
        current: _toConsumableArray(_this.state.city)
      });
    });

    _defineProperty(_assertThisInitialized(_this), "compare", function (a, b) {
      return b.view - a.view;
    });

    _defineProperty(_assertThisInitialized(_this), "refreshData", function (event) {
      _this.getData(event.target.value);
    });

    _defineProperty(_assertThisInitialized(_this), "getData", function (period) {
      var data = {
        period: period
      };
      if ("admin" in _this.props) data = {
        period: period,
        username: _this.props.params.username
      };
      axios__WEBPACK_IMPORTED_MODULE_1___default().post('/useranalytics', data).then(function (res) {
        if (res.status == 200) {
          var _data = res.data;
          var details = Object.keys(_data.details).map(function (key) {
            return {
              device: key,
              view: _data.details[key].view,
              click: _data.details[key].click
            };
          });
          var city = Object.keys(_data.city).map(function (key) {
            return {
              name: key,
              view: _data.city[key].view,
              click: _data.city[key].click
            };
          });
          var country = Object.keys(_data.country).map(function (key) {
            return {
              name: key,
              view: _data.country[key].view,
              click: _data.country[key].click
            };
          });
          details.sort(_this.compare);
          city.sort(_this.compare);
          country.sort(_this.compare);
          var _dateclick = [],
              _dateview = [],
              _ctr = [];
          Object.keys(_data.date).forEach(function (date) {
            _dateclick.push({
              label: date,
              y: _data.date[date].click
            });

            _dateview.push({
              label: date,
              y: _data.date[date].view
            });

            _ctr.push({
              label: date,
              y: (!_data.date[date].view ? 0 : _data.date[date].click * 100 / _data.date[date].view).toFixed(2) + "%"
            });
          });
          var links = Object.keys(_data.links).map(function (link) {
            return {
              url: _data.links[link].url,
              view: _data.links[link].clicks,
              title: _data.links[link].title
            };
          });
          var ref = Object.keys(_data.ref).map(function (link) {
            var _link = _data.ref[link];
            var sublinks = Object.keys(_link).map(function (key) {
              return {
                link: key.replace('http://', '').replace('https://', '').replace('www.', ''),
                view: _link[key],
                url: key
              };
            });
            return {
              host: link.replace('http://', '').replace('https://', '').replace('www.', ''),
              view: _data.ref[link].view,
              sublinks: sublinks
            };
          });
          links.sort(_this.compare);
          ref.sort(_this.compare);
          var reflength = ref.reduce(function (prev, link) {
            return prev + link.view;
          }, 0);
          var linklength = links.reduce(function (prev, link) {
            return prev + link.view;
          }, 0);
          var sublinkview = Array(ref.length);
          sublinkview.fill(false);

          _this.setState(_objectSpread(_objectSpread({}, _data), {}, {
            details: details,
            city: city,
            current: country,
            country: country,
            links: links,
            viewbydate: _dateclick,
            clickbydate: _dateview,
            ctr: _ctr,
            ref: ref,
            totallinkview: linklength,
            reflength: reflength,
    ...
    _defineProperty(_assertThisInitialized(_this), "setSubLinkView", function (index) {
      var _link = _this.state.sublinkview.map(function (v, _index) {
        return index == _index ? !v : false;
      });
    ...
    _this.toggleDataSeries = _this.toggleDataSeries.bind(_assertThisInitialized(_this));
    _this.addSymbols = _this.addSymbols.bind(_assertThisInitialized(_this));
    _this.now = new Date().toISOString().slice(0, 10);
    _this.state = {
      total: {
        view: 0,
        click: 0
      ...
      from: _this.now.toString(),
      to: _this.now.toString(),
      details: [{
        device: 'Mobile',
        view: 0,
        click: 0
  ...
  _createClass(AnalyticsComponent, [{
    ...
    value: function toggleDataSeries(e) {
    ...
    value: function componentDidMount() {
      (0,_config_config__WEBPACK_IMPORTED_MODULE_2__.setMetaData)("Analytics - Cookie", "Analytics Page");
      this.getData(7);
    }
  }, {
    key: "render",
    value: function render() {
      ...
      var options = {
        ...
        title: {
          text: "Views And Clicks (".concat(this.state.from, "~").concat(this.state.to, ")")
        },
        axisX: {
      ...
      return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)("div", {
        ...
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)("div", {
          className: "d-flex flex-column w-100 h-100 bg-white scroll bg-white home-layout",
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)("div", {
            className: "col-12 col-xl-7 divide-light-right p-0 h-100",
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)("div", {
              className: "settings-header d-flex justify-content-between",
              children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)("div", {
                children: "Analytics"
            ...
            }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(react_tooltip__WEBPACK_IMPORTED_MODULE_3__["default"], {
              id: "traffic-desc",
              type: "dark",
              place: "right",
              style: {
              ...
              children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)("span", {
                children: ["Excluding direct traffic to your profile (cookie.link/", this.props.params.username, ").", /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)("br", {}), "Direct traffic has no referring website or location to track."]
              })
            }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)("table", {
              className: "w-100 table-container",
              children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)("thead", {
                children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)("tr", {
                  children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)("td", {
                    children: "Total"
                  }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)("td", {
                    children: [(0,_config_config__WEBPACK_IMPORTED_MODULE_2__.displayNumber)(this.state.part.view), " Views"]
                  }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)("td", {
                    children: [(0,_config_config__WEBPACK_IMPORTED_MODULE_2__.displayNumber)(this.state.part.click), " Clicks"]
                  })]
                })
                ...
                children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)("tr", {
                  ...
                  children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)("td", {
                    children: ["Traffic Sources", /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)("a", {
                      "data-tip": true,
                      "data-for": "traffic-desc",
                      className: "ml-2",
                    ...
                    children: "Views / Clicks"
                  }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)("td", {
                    children: "Share"
                  })]
                }), this.state.reflength ? this.state.ref.map(function (ref, index) {
                  return ref.view ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.Fragment, {
                    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)("tr", {
                      onClick: function onClick() {
                        return _this2.setSubLinkView(index);
                      },
                      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)("td", {
                        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)("i", {
                          "class": "bi ".concat(_this2.state.sublinkview[index] ? 'bi-caret-down-fill' : 'bi-caret-right-fill', " text-gray")
                        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)("span", {
                          className: "ml-3",
                          children: ref.host
                        })]
                      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)("td", {
                        children: (0,_config_config__WEBPACK_IMPORTED_MODULE_2__.displayNumber)(ref.view)
                      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)("td", {
                        children: [(ref.view * 100 / _this2.state.reflength).toFixed(0), "%"]
                      })]
                    }), _this2.state.sublinkview[index] ? ref.sublinks.map(function (sub) {
                      return sub.link != "view" ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)("tr", {
                        className: "sub-traffic",
                        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)("td", {
                          ...
                          children: (0,_config_config__WEBPACK_IMPORTED_MODULE_2__.displayNumber)(sub.view)
                        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)("td", {
                          children: [(sub.view / ref.view * 100).toFixed(0), "%"]
                        })]
                      }) : "";
                    }) : '']
                  }) : '';
                  ...
                  className: "p-header",
                  children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)("td", {
                    children: "Outbound Clicks"
                  })
                }), this.state.links.map(function (link) {
                  return link.view ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)("tr", {
                    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)("td", {
                      children: link.title
                    }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)("td", {
                      children: (0,_config_config__WEBPACK_IMPORTED_MODULE_2__.displayNumber)(link.view)
                    }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)("td", {
                      children: [(link.view * 100 / _this2.state.totallinkview).toFixed(0), "%"]
                    })]
                  }) : '';
                }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)("tr", {
                  className: "p-header",
                ...
                }), this.state.current.map(function (co) {
                  return co.view ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)("tr", {
                    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)("td", {
                      children: co.name
                    }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)("td", {
                      children: (0,_config_config__WEBPACK_IMPORTED_MODULE_2__.displayNumber)(co.view)
                    }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)("td", {
                      children: [(co.view * 100 / _this2.state.part.view).toFixed(0), "%"]
                    })]
                  }) : '';
                }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)("tr", {
                  className: "p-header",
                ...
                }), this.state.details.map(function (detail, index) {
                  return detail.view ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)("tr", {
                    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)("td", {
                      children: [index + 1, ".", detail.device]
                    }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)("td", {
                      children: (0,_config_config__WEBPACK_IMPORTED_MODULE_2__.displayNumber)(detail.view)
                    }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)("td", {
                      children: [(detail.view * 100 / _this2.state.part.view).toFixed(0), "%"]
                    })]
                  }, index) : '';
                })]
              })]
...
var Analytics = function Analytics(props) {
  var params = (0,react_router__WEBPACK_IMPORTED_MODULE_5__.useParams)();
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(AnalyticsComponent, _objectSpread(_objectSpread({}, props), {}, {
    params: params
  }));
};
